...
namespace Ex03.GarageLogic.Vehicles
{
    ...
    {
        private const float k_MaximumFuelInTankByLiter = 55f;
        private readonly eEnergyTypes m_FuelType = eEnergyTypes.Octane96;

        internal FuelBasedCar(string i_ModelName, string i_LicenseNumber, float i_RemainingEnergyPercentage, string i_OwnerName, string i_PhoneNumber, eVehicleGarageStatus i_VehicleStatus)
