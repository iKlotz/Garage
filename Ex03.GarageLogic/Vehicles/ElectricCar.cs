...
namespace Ex03.GarageLogic.Vehicles
{
    public class ElectricCar : Car
    {
        ...
        internal ElectricCar(string i_ModelName, string i_LicenseNumber, float i_RemainingEnergyPercentage, string i_OwnerName, string i_PhoneNumber, eVehicleGarageStatus i_VehicleStatus)
